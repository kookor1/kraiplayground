# KR AI Playground Pages

Minimal GitHub Pages setup for KR AI Playground.
...
- These pages are intentionally simple so they can be submitted quickly for platform review.
